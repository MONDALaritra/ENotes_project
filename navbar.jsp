...
<!-- -start Navbar -->
<!-- ${pageContext.request.contextPath} is used for getting the localhost8080:/project_name part -->
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="user/addnotes">Add Notes</a>
        </li>
       <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="user/viewnotes">View Notes</a>
        </li>
          </c:if> 
      </ul>
      ...
      <c:if test="${not empty userObj}">
	        ...
	        <li class="nav-item">
	          	<a class="nav-link btn btn-outline-danger" aria-current="page" href="user/logout">Logout</a>
	        </li>
       </c:if>
